...
class ScenariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create scenario" do
    assert_difference("Scenario.count") do
      post scenarios_url, params: { scenario: { description: @scenario.description, has_guard: @scenario.has_guard, is_sun_blocking: @scenario.is_sun_blocking, scenario_name: @scenario.scenario_name, scenario_title: @scenario.scenario_title } }
    end
  ...
  test "should update scenario" do
    patch scenario_url(@scenario), params: { scenario: { description: @scenario.description, has_guard: @scenario.has_guard, is_sun_blocking: @scenario.is_sun_blocking, scenario_name: @scenario.scenario_name, scenario_title: @scenario.scenario_title } }
